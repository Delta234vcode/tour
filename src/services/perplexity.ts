...
Знайди та виведи:
1. ВСІ концерти за останні 3-4 роки (ДД.ММ.РРРР, місто, країна, майданчик, кількість проданих квитків лише з джерела або н/д)
2. Заплановані майбутні концерти та тури
3. Скасовані концерти (позначити окремо)
4. Типові ціни квитків (мін/макс/VIP) — тільки якщо є джерело; інакше н/д
5. Середня відвідуваність концертів
6. Географія турів (які регіони/країни охоплює)
